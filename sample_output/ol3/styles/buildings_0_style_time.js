...
var style_buildings_0 = function(feature, resolution){
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(74,209,153,1.0)'}),
...
style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(74,209,153,0.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill)
    })];
}
...
function update() {
    ...
    var features = lyr_buildings_0.getSource().getFeatures();
